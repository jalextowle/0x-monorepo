...
contract WrappedOrderTokens is IERC1155 {
        ...
        public
    {
        ...
        LibOrder.Order memory goodFaithDeposit = makeDepositOrder(
        ...
        // MUSTDO: require that deposit taker asset be a NotCoin
        ...
        exchange.fillOrder(
            goodFaithDeposit,
            goodFaithDeposit.takerAssetAmount,
     ...
     *      makeSettlementOrder(
     *          tokenOwnerAddress,
     *          extractFungibilitySelector(tokenId),
    ...
    function makeCompensationOrder(
        ...
        bytes memory takerTokenHolderSignature,
        uint256 salt
    )
        public pure returns (LibOrder.Order memory)
    {
